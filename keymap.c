...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT( // numbers and symbols
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_CAPS, KC_GRV,  KC_BSLS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS),
  [2] = LAYOUT( // functions
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
    KC_TAB,  KC_VOLD, KC_VOLU, KC_ESC,  KC_TRNS,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F11,
  ...
  [4] = LAYOUT( // mouse
    ...
    KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_BTN3,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS)
};

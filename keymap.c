...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT( // functions
    ...
    KC_TAB,  KC_TRNS, KC_VOLD, KC_VOLU, KC_TRNS,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_F11,  KC_F12,
    KC_MUTE, KC_MPLY, KC_MPRV, KC_MNXT, KC_DEL,                       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F18,
  ...
  [4] = LAYOUT( // mouse
    ...
    KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_TRNS,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                               KC_TRNS, KC_TRNS,                      KC_TRNS, KC_TRNS)
};
